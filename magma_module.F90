...
interface
    ...
    subroutine magma_dset_pointer( &
        ...
        batch_offset, &
        batchCount, queue ) &
    bind(C, name="magma_dset_pointer")
        use iso_c_binding
        type(c_ptr), value :: output_array, input
        integer(c_int), value :: lda, row, column, batch_offset, batchCount
        type(c_ptr), value :: queue
    end subroutine
